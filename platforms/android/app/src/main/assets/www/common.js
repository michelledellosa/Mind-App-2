...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CouponsService": () => (/* binding */ CouponsService)
/* harmony export */ });
...
let CouponsService = class CouponsService {
    ...
    getCoupons() {
        ...
        if (this.userData.token) {
            ...
            return this.http.post(this.apiUrl + '/cuponesManejo', body, { 'headers': headers });
        }
        else {
            return JSON.parse('1');
        }
...
CouponsService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
let RewardService = class RewardService {
    ...
    getRewards() {
        ...
        return this.http.post(this.apiUrl + '/promocionesManejo', body, { 'headers': headers });
    }
};
...
RewardService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
        providedIn: 'root'
    })
], RewardService);
